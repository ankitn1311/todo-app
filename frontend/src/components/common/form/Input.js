  ...
  return (
    <div className={` relative flex flex-col ${width === "full" && "w-full"}`}>
      <input
        {...props}
        formik=""
        className={`px-3 py-2 w-full shadow-sm border-1   placeholder-gray-400 text-slate-700 disabled:bg-gray-50 disabled:text-gray-500 disabled:border-gray-200 bg-slate-100 focus:outline-none   dark:text-slate-100 rounded-md  outline-none placeholder:text-xs dark:bg-slate-600 ${
          error
